...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _modules_tasks_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/tasks.js */ \"./src/modules/tasks.js\");\n\r\n\r\n\r\nconst lists = document.querySelector('.lists');\r\nconst addBtn = document.querySelector('#add-btn');\r\n\r\n(0,_modules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.checkTasks)();\r\n\r\naddBtn.addEventListener('click', () => {\r\n  const description = document.getElementById('add-input').value;\r\n  (0,_modules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.addTask)(description);\r\n  lists.insertAdjacentHTML('beforeend', `<li class=\"task-item\" contentEditable = \"false\"><input type=\"checkbox\">${description}<i id=\"task-btn\" class=\"fa-solid fa-ellipsis-vertical\"></i></li>`);\r\n  document.getElementById('add-input').value = \"\";\r\n});\r\n\r\n\r\n  document.body.addEventListener('click', (e) => {\r\n \r\n    if (e.target.classList.contains('fa-trash')){\r\n      e.target.parentElement.remove();\r\n      (0,_modules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.removeTask)(_modules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.tasks.index);\r\n    }\r\n    if (e.target.classList.contains('fa-ellipsis-vertical')){\r\n    e.target.parentElement.contentEditable = \"true\";\r\n    e.target.classList.remove('fa-ellipsis-vertical');\r\n    e.target.classList.add('fa-trash');}\r\n    (0,_modules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.editTask)(_modules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.tasks.description);\r\n  })\r\n\r\n\r\n\r\n\r\n \r\n\r\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
